...
class DailiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create daily" do
    assert_difference('Daily.count') do
      post dailies_url, params: { daily: { content: @daily.content, dailyimage: @daily.dailyimage, title: @daily.title } }
    end
  ...
  test "should update daily" do
    patch daily_url(@daily), params: { daily: { content: @daily.content, dailyimage: @daily.dailyimage, title: @daily.title } }
